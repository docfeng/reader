...
<div class="top_box1" id="top_box">
    <div class="control_box" id="control_box">
        ...
        <input type="button" value="http" onclick="phpFSO.http()"/>
...
phpFSO={
    read:function(){
        ...
        http.post(path,str).then(function(text){
            page.txt.value=text
        });
    },
    write:function(){
        ...
        http.post(path,str).then(function(re){
            alert(re);
        });
    },
    add:function(){
    ...
    http:function(){
        var url=page.name.value;
        http.get("http://gear.docfeng.top/get2.php?url="+url).then(function(text){
            page.txt.value=text
        });
    }
}
...
window.onload=function(){
    ...
    addForm(5);addForm(6);
    shift(1);
    ///alert(window.getComputedStyle(page.txt).height)
    //alert(window.getComputedStyle(edit_box).height)
    //page.txt.focus()
    //window.onresize();
}

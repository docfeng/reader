    ...
    window.section=async function(i,t){
      et.removeClass("fn-on cfg-on");
        ...
        //如果页面<=0,上一章;
          //pageIndex = 1;
          //upChapter();
          await window.page(novel.index1-1);
        ...
        u = {
            ...
            move: function(i) {
                ...
                if ("lr" == F && (c = Number(a) < 250 && Math.abs(n.x) > 20 || Math.abs(n.x) > r / 4), "ud" == F && (c = Number(a) < 250 && Math.abs(n.y) > 20 || Math.abs(n.y) > s / 4), !o && "lr" == F) {
                    ...
                    if (d) return void(1 == pageIndex && n.x > 0 ? upChapter() : pageIndex == pageCount && n.x < 0 && nextChapter());
                ...
                if (o && "ud" == F) {
                    ...
                    n.y > 0 && et.scrollTop() <= 0 && (f++, f >= 2 && upChapter())
                }
